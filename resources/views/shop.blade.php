            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    @foreach ($products as $item)
                        <div class="col-md-4">
                            <form action="{{ route('shoppingCart', $item->productID) }}" method="POST">
                                @csrf
                                <div class="card mb-4 product-wap rounded-0">
                                    <div class="card rounded-0">
                                        ...
                                        <div
                                            ...
                                            <ul class="list-unstyled">
                                                <li>
                                                    <button class="btn btn-success text-white"><i class="fas fa-cart-plus"
                                                            style="color: #d1d7e1;"></i></button>
                                                </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-center mb-0">{{ '$' . number_format($item->price, 2, '.', ',') }}</p>
                                    </div>
                                </div>
                            </form>
                        </div>
