        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset('assets/img/' . $product->img) }}" alt="Card image cap"
                            id="product-detail">
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod temp incididunt ut
                                labore
                                et dolore magna aliqua. Quis ipsum suspendisse. Donec condimentum elementum convallis. Nunc
                                sed
                            ...
                            <form action="{{ route('shoppingCart', $product->productID) }}" method="POST">
                                @csrf
